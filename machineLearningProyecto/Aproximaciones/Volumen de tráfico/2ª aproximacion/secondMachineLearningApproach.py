...
def creacionElementosDiccionario(intervalo1, intervalo2, hora_del_dia, hora_de_referencia,day,df1_aux,route, modelo):
        try:
        ...
        model = ARIMA(serie, order= modelo)
        model_fit = model.fit(disp=0)
        ...
        try:
                ...
                for pair in pairs:
                        ...
                        for day in days:
                              ...
                              creacionElementosDiccionario("TIME '6:00:00' AND TIME '7:40:00'","TIME '8:00:00' AND TIME '9:40:00'", 0, datetime.datetime(2018,1,1,8,0,0),day,df1_aux,pair,modelo)
                              creacionElementosDiccionario("TIME '15:00:00' AND TIME '16:40:00'","TIME '17:00:00' AND TIME '18:40:00'", 1, datetime.datetime(2018,1,1,17,0,0),day,df1_aux,pair,modelo)
        except:
                 continue  
